    ...
    return (
        <header style={{
            ...
            <form onSubmit={handleSubmit} className=''>
                <div className="flex justify-between w-[18rem] mx-auto mb-5 gap-2">
                    <input className="text-sm w-5/6 p-2  rounded-lg" name='text' value={query} onChange={(e) => setQuery(e.target.value)} type="text" placeholder='Введите название книги' />
                ...
                <div className="w-[18rem] mx-auto grid grid-cols-2 gap-3 justify-between">
                    <select
